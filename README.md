...
An OKLCH color composition system for Tailwind CSS v4. Build entire color schemes from three independent axes — **luminance**, **chroma**, and **hue** — using atomic utility classes that cascade through the DOM.
...
That's it. No `tailwind.config.js` required — this is a Tailwind v4 native setup.
