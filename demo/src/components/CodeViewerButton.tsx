	...
	return (
		<>
			<button
				...
				className="absolute top-2 right-2 p-1.5 rounded-md text-[0.7rem] font-mono leading-none opacity-40 hover:opacity-100 transition-opacity cursor-pointer bg-lum-12 chroma-lo text-lum-1"
				title="View source"
			>
				&lt;/&gt;
			</button>
			...
			<dialog
				...
				className="mx-0 mb-0 mt-auto sm:m-auto max-w-full sm:max-w-[720px] w-full sm:w-[90vw] max-h-[85vh] sm:max-h-[80vh] rounded-t-xl sm:rounded-xl p-0 border hue-neutral border-lum-6 chroma-lo bg-transparent backdrop:bg-black/50 backdrop:backdrop-blur-sm"
			>
